      ...
      <main className="min-h-full w-full flex justify-center bg-slate-50">
        <div className="pt-28 w-full max-w-[800px] flex flex-col items-center bg-white border shadow-md">
          ...
          <div className="relative px-2 mt-10 w-full max-w-[650px]">
            ...
            />
            {/* <span className="sm:w-40 sm:h-14 sm:aspect-square flex items-center justify-center absolute top-1/2 right-4 sm:right-5 transform -translate-y-1/2 rounded-lg md:rounded-full duration-150 text-xs">
              <span className="text-gray-400">{hanPrice}</span>
            </span> */}
            <span className="sm:w-40 sm:h-14 sm:aspect-square flex items-center justify-end absolute top-1/2 right-4 sm:right-5 transform -translate-y-1/2 rounded-lg md:rounded-full duration-150 text-xs">
              <span className="text-gray-400">{hanPrice}</span>
            </span>
          </div>
