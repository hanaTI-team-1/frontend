      ...
      <section className="p-20 space-y-10">
        ...
        <InsightArticle title={"해석"}>
          <table>
            <tbody>
              <tr>
                <td className='w-20 align-top'>Cluster 0</td>
                <td>해당 군집은 학교를 중요시 하는 유형입니다.</td>
              </tr>
              <tr>
                <td className='w-20 align-top'>Cluster 1</td>
                <td className='h-10 bg-blue-300'>해당 군집은 전세가격에 PRC가 높으므로 금전적으로 여유가 있는 유형입니다.</td>
              </tr>
              <tr>
                <td className='w-20 align-top'>Cluster 2</td>
                <td>해당 군집은 버스와 지하철 거리에 민감한 교통 민감 유형입니다.</td>
              </tr>
              <tr>
                <td className='w-20 align-top'>Cluster 3</td>
