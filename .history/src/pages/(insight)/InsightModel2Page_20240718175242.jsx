      ...
      <section className="p-20 space-y-10">
          ...
          <table>
            <tbody>
              ...
              <tr>
                ...
                <td>해당 군집은 전세가격에 PRC가 높으므로 금전적으로 여유가 있는 유형입니다.</td>
              </tr>
              <tr>
                <td className='w-20 align-top font-semibold'>Cluster 2</td>
                <td>해당 군집은 버스와 지하철 거리에 민감한 교통 민감 유형입니다.</td>
              </tr>
              <tr>
                <td className='w-20 align-top font-semibold'>Cluster 3</td>
                <td>해당 군집은 다른 군집들에 비해 특출나게 선호하는 것이 없는 무난한 유형입니다.</td>
              </tr>
            </tbody>
          </table>
        </InsightArticle>
        ...
        <InsightArticle title={ "결론"}> 
          <p className="mt-1 w-full">
            저희 팀은 빠른 추천 서비스를 위해서 비교적 빠른 clustering model인 kmeans 모델을 활용해 진행하였습니다.
            그리고 적절한 k개수를 파악하기 위해 elbow, silhouette Plot 등 시각화 방법을 사용하였고, 군집화된 데이터를
            시각화 하여 분석을 진행해 해석을 진행하여 서비스에 필요한 추천 시스템을 개발할 수 있었습니다.
          </p>
        </InsightArticle>
      </section>
    </>
