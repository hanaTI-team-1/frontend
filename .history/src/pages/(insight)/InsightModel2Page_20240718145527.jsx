      ...
      <section className="p-20 space-y-10">
        <InsightArticle title={"1. 검증곡선"}>
          ...
          <p className="px-10 mt-5">
            ...
            모델의 성능이 어떻게 변하는지를 보여줍니다. max_depth 가 6일때부터
            교차 검증 점수가 일정하고 훈련 데이터 점수는 8~10 즈음부터 성능
            차이가 없으므로 max_depth가 몰라 설명더 써주셈
          </p>
        </InsightArticle>

        <InsightArticle title={"2. 잔차"}>
          <img src="/insight/model-1/residuals.png" width={500} height={500} />
          <ul className="px-10 mt-5">
            <li>의미: 실제 값과 예측 값의 차이를 나타냅니다.</li>
            <li className="mt-2">
              목적: 잔차가 특정 패턴을 보이지 않고 무작위로 분포해야 좋은
              모델입니다. 잔차 그래프를 통해 모델이 특정 패턴이나 편향을 가지고
              있는지 확인할 수 있습니다.
            </li>
          </ul>
        </InsightArticle>
        ...
        <InsightArticle title={"3. 특징 중요도"}>
          ...
          <hgroup className="px-10 pt-5 space-y-5">
            ...
            <p>
              데이터 크기에 따른 모델 성능 변화를 보여줌. 데이터 크기가 커질수록
              훈련 모델 성능은 떨어짐
            </p>
          </hgroup>
        </InsightArticle>
          ...
          <hgroup className="px-10 pt-5 space-y-5">
            ...
            <ol className="pl-3">
              <li>
                ...
                완벽하게 학습하기 어려워짐. 모델은 훈련 데이터에 과도하게
                적합되어 훈련 데이터에 대한 점수(정확도, R^2 등)가 낮아질 수도
                있음
              </li>
              <li className="mt-2">
