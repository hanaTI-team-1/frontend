import SeoulGuMap from "../../components/map/SeoulGuMap";

export default function RecommendGu() {
  return (
    <>
      <div className="min-h-full w-full flex justify-center bg-slate-50">
        <div className=" pt-28 w-full max-w-[800px] flex flex-col items-center bg-white border shadow-md">
          ...
          <p className="text-xs sm:text-md text-center break-keep text-slate-400">
            현재 서울 5개 구 선택 가능
          </p>
          <SeoulGuMap />
        </div>
