      ...
      <Link to={url}>
        <div className="h-full flex flex-col justify-evenly">
          <div className="flex items-center">
            <span className="p-1 bg-sky-200 text-blue-600 rounded-lg font-bold">
              도로명
            </span>
            <div className="pl-3 text-sm text-neutral-700">
              {result.roadAddr}
            </div>
          </div>
          <div className="flex items-center">
            <span className="p-1 bg-gray-300 rounded-lg font-bold">구주소</span>
